...
Standard input is incremental and UTF-8 decoding is strict. A failure can leave
...
Ranges count UTF-8 bytes in each original source. Neither format prints matched
file content. Text reports and diagnostics escape non-printing path characters
